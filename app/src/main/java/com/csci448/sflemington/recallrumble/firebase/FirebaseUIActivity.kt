...
abstract class FirebaseUIActivity : AppCompatActivity() {
    ...
    private fun onSignInResult(result: FirebaseAuthUIAuthenticationResult) {
        ...
        if (result.resultCode == RESULT_OK) {
            ...
            Toast.makeText(applicationContext, "You have successfully signed in!", Toast.LENGTH_LONG).show()
        } else {
    ...
    private fun themeAndLogo() {
        ...
        val signInIntent = AuthUI.getInstance()
            ...
            .setTheme(R.style.Theme_RecallRumble) // Set theme
            .build()
        signInLauncher.launch(signInIntent)
    ...
    open fun emailLink() {
        ...
        val actionCodeSettings = ActionCodeSettings.newBuilder()
            .setAndroidPackageName( /* yourPackageName= */
                "com.csci448.sflemington.recallrumble.firebase",  /* installIfNotAvailable= */
                true,  /* minimumVersion= */
                null)
            .setHandleCodeInApp(true) // This must be set to true
            .setUrl("https://recallrumble.page.link") // This URL needs to be whitelisted
            .build()
